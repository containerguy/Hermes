# Milestone v1.0: Hermes v1 Release Hardening
...
This milestone turns Hermes into a safer release candidate for the LAN party: harden auth/invites, make capacity-limited writes correct under concurrency, make S3 restore operator-safe, improve PWA/realtime reliability, modularize the frontend, and finish with focused tests + deployment documentation.

## Archived ROADMAP.md (verbatim)
